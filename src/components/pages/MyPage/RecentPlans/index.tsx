...
import { getPlanPeriod, getDDay, getMyPageData } from '@/components/pages/MyPage/profile/entities';

export default async function RecentPlans() {
  const { recentPlans } = await getMyPageData();
