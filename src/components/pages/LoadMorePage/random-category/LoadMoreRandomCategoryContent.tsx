...
import { useInfiniteMoreNightRandomRecommend } from '@/components/pages/LoadMorePage/entities';
...
export default function LoadMoreRandomCategoryContent() {
  const searchParams = useSearchParams();
  const type = searchParams.get('type') ?? '';

  const { data, fetchNextPage, hasNextPage, isFetchingNextPage } =
    useInfiniteMoreNightRandomRecommend(type);
