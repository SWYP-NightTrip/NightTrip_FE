...
import PopularSuggestion from '@/components/pages/searchPage/popularSuggestion/PopularSuggestion';
import RecommendSuggestions from '@/components/pages/searchPage/recommendSuggestion/RecommendSuggestions';
import SearchSuggestions from '@/components/pages/searchPage/searchSuggestion/SearchSuggestions';
